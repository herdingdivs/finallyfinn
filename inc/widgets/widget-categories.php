      ...
      if(have_posts()): 
        ...
        ?>
            ...
            <?php echo substr( strip_tags( get_the_excerpt() ),0,50)."...";  ?>
               &nbsp;&nbsp;&nbsp;<a class="read_more" style="color: #e4e4e4;" href="<?php echo get_permalink(); ?>"><?php echo __('More info',"sauron");?></a>
             </div> 
  ...
  /*Creates the form for the widget in the back-end. */
    ...
    <select name="<?php echo $this->get_field_name('categ_id'); ?>" id="<?php echo $this->get_field_id('categ_id') ?>" style="font-size:12px" class="inputbox">
     ...
     <?php  $categories=get_categories();
       ...
       ?>
          <option value="<?php echo $categorie->term_id?>" <?php if($instance['categ_id']==$categorie->term_id) echo  'selected="selected"'; ?>><?php echo $categorie->name ?></option>
     <?php
            }
       ?>
        </select></p>   
    <p><label for="<?php echo $this->get_field_id('select_view'); ?>"></label>
      <input type="radio" name="<?php echo $this->get_field_name('select_view'); ?>" value="0" <?php if($select_view==0 || $select_view=="") echo 'checked="checked"'; ?>><?php echo __("Title", "sauron"); ?>
      <input type="radio" name="<?php echo $this->get_field_name('select_view'); ?>" value="1" <?php if($select_view==1 || $select_view=="") echo 'checked="checked"'; ?>><?php echo __("Desciption", "sauron"); ?>
    </p>
