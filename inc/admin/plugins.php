...
function wdwt_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			'page_title'                      => __( 'Install Recommended Plugins', "sauron" ),
			'menu_title'                      => __( 'Recommended Plugins', "sauron" ),
			'installing'                      => __( 'Installing Plugin: %s', "sauron" ), // %s = plugin name.
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', "sauron" ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', "sauron" ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', "sauron" ), // %s = dashboard link.
